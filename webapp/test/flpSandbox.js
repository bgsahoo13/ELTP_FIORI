		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#eltpfiorieltpfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eltpfiorieltpfiori-display": {
								"semanticObject": "eltpfiorieltpfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=eltp.fiori.eltpfiori",
									"url": sap.ui.require.toUrl("eltp/fiori/eltpfiori")
								}
							}
						}
					}
